...
function ProductDetail() {
  const { setLocalStorageData, setTotalCartItem } = useContext(MyContext);
          ...
          {detailLoading ? (
            ...
            <div className="flex items-center justify-center gap-8 flex-col lg:flex-row">
              <img
                ...
                className="w-full sm:w-[70%] object-cover min-h-[25rem] lg:w-2/6 "
                alt=""
              />
              <div className="flex flex-col items-baseline gap-4 lg:w-2/5">
                ...
                <h2 className="text-4xl ">{productDetail.title}</h2>
